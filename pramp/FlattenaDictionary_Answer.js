...
If your peer makes some progress with the recursive approach, and is stuck at some other point, try to give some hints regarding how keys of the dictionary could be manipulated.
Watch out of cases when the key is an empty string or null. For instance, consider the case where the input dictionary itself isn’t associated with any key.
*/


/**
Answer: Flatten a Dictionary
