...
/*
step1  sort grantsArray = [2, 50, 100, 120, 1000]
step2  cap = 190/5 = 38
    [2, 50, 100, 120, 1000]
step3  2<38  2 is keep
*/
function findGrantsCap(grantsArray, newBudget) {
    // your code goes here

    let grantsLen = grantsArray.length;
    let cap = newBudget / grantsLen;
